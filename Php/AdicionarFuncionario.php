            ...
            <div class="w-75 py-5 h-75 text-center col-sm-7 mx-auto">
                <form class="text-center py-5 my-5 w-100" method="post" action="Insert.php">
                    <div class="form-group w-100"><label class="">NOME: <br></label>
                        <input type="text" class="form-control" placeholder="Nome do Funcionario" name="nome"></div>
                    <div class="form-group w-100"><label class="">MATRICULA: <br></label>
                        <input type="text" class="form-control" placeholder="Matricula do Funcionario" name="matricula">
                    </div>
                    <div class="form-group w-100"><label>SENHA: </label>
                        <input type="password" class="form-control" placeholder="Senha do Funcionario" name="senha">
                    </div>
                    <button type="submit" name="AdicionarFuncionario"
